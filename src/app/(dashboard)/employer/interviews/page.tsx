...
const SCHEDULED_AND_COMPLETED_ROUNDS = [
  {
    ...
    opportunityRef: 'Opportunity #1 of 3 (Assurance-Backed)',
    roundLabel: 'Round 1 — Technical & Algorithmic Assessment Panel',
    scheduledDate: '12 Sep 2026, 11:00 IST',
    ...
    evaluationScore: '86/100 (Recommended for Round 2)',
  ...
  },
  {
    ...
    institution: 'Apex Institute of Technology (APX123)',
    roleTitle: 'Full-Stack Software Engineer (SDE-1)',
    opportunityRef: 'Opportunity #2 of 3 (Assurance-Backed)',
    roundLabel: 'Round 2 — System Design & Architecture Panel',
    scheduledDate: '28 Sep 2026, 15:00 IST',
    interviewerPanel: 'Ananya Sundaram (Principal Architect)',
    attendanceStatus: 'CONFIRMED_UPCOMING',
    lifecycleStatus: 'SCHEDULED (Video Room Active)',
    evaluationScore: 'Pending Panel Evaluation Rubric',
    badgeVariant: 'blue',
  },
  {
    id: 'iv-nexa-03',
    ...
    roleTitle: 'Full-Stack Software Engineer (SDE-1)',
    opportunityRef: 'Opportunity #2 of 3 (Assurance-Backed)',
    roundLabel: 'Round 1 — Frontend & TypeScript Engineering Panel',
    scheduledDate: '29 Sep 2026, 11:30 IST',
    interviewerPanel: 'Siddharth Menon (Staff Engineer)',
    attendanceStatus: 'CONFIRMED_UPCOMING',
    lifecycleStatus: 'SCHEDULED (Video Room Active)',
    evaluationScore: 'Pending Panel Evaluation Rubric',
    badgeVariant: 'blue',
