...
export const INSTITUTION_COMMERCIAL_PLANS = [
  {
    ...
    waiverSummary: '₹15,000 / year + GST (Year-1 fee waived with 100+ students)',
    summary:
  ...
  },
  {
    ...
    waiverSummary: '5 Years for the Price of 4 (₹15,000 already waived off ₹75,000)',
    summary:
...
export const STUDENT_PROGRAMME_PLANS = [
  {
    ...
    subtitle: '9-Area Job-Readiness Assessment, Verified Credential & 3 Corporate Interview Opportunities',
    baseFeeInr: 1000,
    basePriceInr: 1000,
    gstAmountInr: 180,
